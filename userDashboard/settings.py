...
SECRET_KEY = '_3l92d6m!16&d5v3forwo*zl^pdd89)fuqbsevuc=n$i(t4!cg'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'userdashboard_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
